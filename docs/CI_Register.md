# Deliverable 2: Configuration Item (CI) Register
...
- **Versioning:**  
  - Documents: 1.0, 1.1 …  
  - Source Code / Database: 0.1 initial, increment as updates occur.

- **Status Legend:**  
  - **Approved:** Part of BL2 baseline  
  - **Under Review:** Waiting for instructor or team approval  
  - **In Progress:** Work ongoing  

- **Ownership:** Each CI owner is responsible for updates, CR implementation, and maintenance. BL2 is the **starting point for the team**, who will make further contributions via feature branches and pull requests.
